...
var daygrid = require("@houdini473/daygrid");
...
function TimeColsAxisCell(props) {
  ...
  return common.createElement(
    common.ViewContextType.Consumer,
    null,
    function (context) {
      if (!props.isLabeled) {
      ...
      var labelFormat = // TODO: fully pre-parse
        options.slotLabelFormat == null
          ...
          ? common.createFormatter(options.slotLabelFormat[0])
...
var TimeColsView = /** @class */ (function (_super) {
    ...
    _this.renderHeadAxis = function (rowKey, frameHeight) {
      ...
      var navLinkAttrs =
        options.navLinks && dayCnt === 1 // only do in day views (to avoid doing in week views that dont need it)
          ? {
              "data-navlink": common.buildNavLinkData(range.start, "week"),
              tabIndex: 0,
            }
          : {};
      if (options.weekNumbers && rowKey === "day") {
        return common.createElement(
          common.WeekNumberRoot,
  ...
  TimeColsView.prototype.renderSimpleLayout = function (
    ...
    if (allDayContent) {
      ...
      sections.push({
        ...
        outerContent: common.createElement(
          "tr",
  ...
  TimeColsView.prototype.renderHScrollLayout = function (
    ...
    var stickyHeaderDates =
      !props.forPrint && common.getStickyHeaderDates(context.options);
    var stickyFooterScrollbar =
      !props.forPrint && common.getStickyFooterScrollbar(context.options);
    var sections = [];
    if (headerRowContent) {
      sections.push({
        type: "header",
...
var TimeColsSlatsCoords = /** @class */ (function () {
  ...
  TimeColsSlatsCoords.prototype.safeComputeTop = function (date) {
    ...
    if (common.rangeContainsMarker(dateProfile.currentRange, date)) {
      ...
      if (
        timeMs >= common.asRoughMs(dateProfile.slotMinTime) &&
  ...
  TimeColsSlatsCoords.prototype.computeDateTop = function (
    ...
    return this.computeTimeTop(
      common.createDuration(when.valueOf() - startOfDayDate.valueOf())
    );
  };
  ...
  TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
    ...
    var slatCoverage =
      (duration.milliseconds - common.asRoughMs(dateProfile.slotMinTime)) /
      common.asRoughMs(this.slotDuration);
    var slatIndex;
    var slatRemainder;
...
var TimeColEvent = /** @class */ (function (_super) {
  ...
  TimeColEvent.prototype.render = function () {
    ...
    return common.createElement(
      common.StandardEvent,
      tslib.__assign({}, this.props, {
      ...
      function (rootElRef, classNames, dataAttrs) {
        return common.createElement(
          ...
          common.createElement(
            ...
            common.createElement(TimeColMisc, {
              date: props.date,
              dateProfile: props.dateProfile,
              todayRange: props.todayRange,
              extraHookProps: props.extraHookProps,
      ...
      return common.createElement(
        ...
        common.createElement(
          ...
          tslib.__assign(
            ...
            common.getSegMeta(seg, props.todayRange, props.nowDate)
          )
        )
      );
    });
          ...
          tslib.__assign(
            {
              ...
              isCondensed:
                seg.bottom - seg.top <
                common.config.timeGridEventCondensedHeight,
            },
            common.getSegMeta(seg, props.todayRange, props.nowDate)
          )
        )
...
var TimeCols = /** @class */ (function (_super) {
  ...
  TimeCols.prototype.positionToHit = function (positionLeft, positionTop) {
    ...
    if (colIndex != null && slatIndex != null) {
      ...
      var time = common.addDurations(
        dateProfile.slotMinTime,
        common.multiplyDuration(snapDuration, snapIndex)
      );
...
function buildSlatMetas(
  ...
  while (common.asRoughMs(slatTime) < common.asRoughMs(slotMaxTime)) {
    ...
    var isLabeled =
      common.wholeDivideDurations(slatIterator, labelInterval) !== null;
    metas.push({
      date: date,
      time: slatTime,
...
var DayTimeColsView = /** @class */ (function (_super) {
  ...
  DayTimeColsView.prototype.render = function () {
    ...
    var headerContent =
      options.dayHeaders &&
      common.createElement(common.DayHeader, {
    ...
    var timeGridContent = function (contentArg) {
      return common.createElement(
        DayTimeCols,
        tslib.__assign({}, splitProps.timed, {
          dayTableModel: dayTableModel,
          dateProfile: dateProfile,
...
function buildTimeColsModel(dateProfile, dateProfileGenerator) {
  var daySeries = new common.DaySeriesModel(
