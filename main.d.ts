...
import { TableCellModel } from "@houdini473/daygrid";
...
declare function buildSlatMetas(
...
declare abstract class TimeColsView extends DateComponent<
  ViewProps,
  TimeColsViewState
> {
...
declare function buildTimeColsModel(
  dateProfile: DateProfile,
...
declare function buildDayRanges(
  dayTableModel: DayTableModel,
  dateProfile: DateProfile,
  dateEnv: DateEnv
): DateRange[];
